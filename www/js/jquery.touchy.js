                        ...
                        if (touches.length === data.settings.requiredTouches) {
                            ...
                            if (touches.length === 1) {
                                ...
                                centerCoords = data.centerCoords = data.centerCoords || {
                                    //MLE "x": targetPageCoords.x + ($target.width() * 0.5),
                                    //MLE "y": targetPageCoords.y + ($target.height() * 0.5)
                            ...
                            radians = Math.atan2((movePoint.y/zoom) - centerCoords.y, (movePoint.x/zoom) - centerCoords.x);
